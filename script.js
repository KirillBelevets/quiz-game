...
const PANTRY_API_URL = 'https://pantry-proxy-api-tau.vercel.app/quiz-scores';
...
async function fetchQuestions() {
    try {
        ...
        console.error('Error fetchich questions:', error);
        questionText.innerText = 'Failed to load'
    }
}
...
// Ensure special characters decoded
